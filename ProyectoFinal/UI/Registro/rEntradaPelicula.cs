...
{
    public partial class rEntradaPelicula : Form
    {
        public rEntradaPelicula()
        {
            InitializeComponent();
            LlenarComboBox();
        }
        ...
        private EntradaPelicula LlenarClase()
        {

            EntradaPelicula entrada = new EntradaPelicula();

            entrada.EntradaPeliculaId = Convert.ToInt32(IdnumericUpDown.Value);
        ...
        {
            Repositorio<Pelicula> repositorio = new Repositorio<Pelicula>(new Contexto());
        ...
        private void Buscarbutton_Click(object sender, EventArgs e)
        {
            ...
            EntradaPelicula entrada = BLL.EntradaPeliculaBLL.Buscar(id);
        ...
        private void Guardarbutton_Click(object sender, EventArgs e)
        {
            ...
            EntradaPelicula entrada = BLL.EntradaPeliculaBLL.Buscar(id);
            EntradaPelicula entrada_guardar = LlenarClase();
            bool paso = false;
            if (Validar(2))
            {
